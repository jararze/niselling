                        ...
                        <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-header">
                                    ...
                                    @php
                                        $selectedStatus = $grade->status; // Replace with your actual model and column
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Select2-->
                                    @php($selectedType = $grade->model_of_cars_id)
                                                ...
                                                <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                                    <div class="col">
                                                        <div class="fv-row mb-7 fv-plugins-icon-container">
                                                            ...
                                                            <input type="text" class="form-control mb-2" name="engine" id="engine" value="{{ $grade->engine }}" placeholder="Motor">
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="fv-row mb-7">
                                                            <div class="fv-row mb-7 fv-plugins-icon-container">
                                                                ...
                                                                <input type="text" class="form-control mb-2" name="cylindered" id="cylindered" value="{{ $grade->cylindered }}" placeholder="Cilindrada">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                                    <div class="col">
                                                        <div class="fv-row mb-7 fv-plugins-icon-container">
                                                            ...
                                                            <input type="text" class="form-control mb-2" name="transmission" id="transmission" value="{{ $grade->transmission }}" placeholder="Transmisión">
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="fv-row mb-7">
                                                            <div class="fv-row mb-7 fv-plugins-icon-container">
                                                                ...
                                                                <input type="text" class="form-control mb-2" name="traction" id="traction" value="{{ $grade->traction }}" placeholder="Tracción">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                                    <div class="col">
                                                        <div class="fv-row mb-7 fv-plugins-icon-container">
                                                            ...
                                                            <input type="number" class="form-control mb-2" name="commercial_date" id="commercial_date" value="{{ $grade->commercial_date }}" placeholder="Año comercial">
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="fv-row mb-7">
                                                            <div class="fv-row mb-7 fv-plugins-icon-container">
                                                                ...
                                                                <input type="text" class="form-control mb-2" name="origin" id="origin" value="{{ $grade->origin }}" placeholder="Origen">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                                    <div class="col">
                                                        <div class="fv-row mb-7 fv-plugins-icon-container">
                                                            ...
                                                            <input type="text" class="form-control mb-2" name="factory" id="factory" value="{{ $grade->factory }}" placeholder="Fabrica">
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="fv-row mb-7">
                                                            <div class="fv-row mb-7 fv-plugins-icon-container">
                                                                ...
                                                                <input type="text" class="form-control mb-2" name="delivery" id="delivery" value="{{ $grade->delivery }}" placeholder="Entrega">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row row-cols-1 row-cols-sm-3 rol-cols-md-1 row-cols-lg-3">
                                                    <div class="col">
                                                        <div class="fv-row mb-7 fv-plugins-icon-container">
                                                            ...
                                                            <input type="number" class="form-control mb-2" name="price" id="price" value="{{ $grade->price }}" placeholder="Precio">
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="fv-row mb-7">
                                                            <div class="fv-row mb-7 fv-plugins-icon-container">
                                                                ...
                                                                <input type="number" class="form-control mb-2" name="discount" id="discount" value="{{ $grade->discount }}" placeholder="0">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="fv-row mb-7">
                                                            <div class="fv-row mb-7 fv-plugins-icon-container">
                                                                ...
                                                                <input type="number" class="form-control mb-2" name="order" id="order" value="{{ $grade->order }}" placeholder="0">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
