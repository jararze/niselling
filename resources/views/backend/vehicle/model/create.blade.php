...
@push('script')
    <script type="text/javascript">
        window.Laravel = {
            ...
            submitEndpoint: '{{ route("backend.vehicle.model.store") }}',
        };
    </script>
    <script src="{{ asset('backend/assets/plugins/custom/formrepeater/formrepeater.bundle.js') }}"></script>
    <script src="{{ asset('backend/assets/js/model/save.js') }}"></script>
@endpush
                                        ...
                                        <div class="card card-flush py-4">
                                            ...
                                            <div class="card-body pt-0">
                                                ...
                                                <div class="mb-10 fv-row">
                                                    <!--begin::Label-->
                                                    <label for="model_name" class="required form-label">Nombre del modelo</label>
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                ...
                                                <div class="mb-10">
                                                    ...
                                                    <!--end::Editor-->
                                                    <!--begin::Description-->
                                                    <div class="text-muted fs-7">Establezca una descripción del modelo para una mejor visibilidad.</div>
                                                    <!--end::Description-->
                                                </div>
                                                ...
                                                <div class="mb-10 fv-row">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="text" class="form-control mb-2" name="data_sheet" id="data_sheet"
                                                           placeholder="https://www.nissan-cdn.net/content/dam/Nissan/BO/brochures/NBO_Frontier4x2_NLAC_Single.pdf?download=1" value=""/>
                                                    <!--end::Input-->
                                                    <!--begin::Description-->
                                                    <div class="text-muted fs-7">Ingrese la url de la ficha tecnica.</div>
                                                    <!--end::Description-->
                                                </div>
                                                <!--end::Input group-->
                                                <!--begin::Input group-->
                                                ...
                                                <div class="fv-row">
                                                    ...
                                                    <div class="form-check form-check-custom form-check-solid mb-2">
                                                        <input class="form-check-input" type="checkbox" value="1" name="sale_online" id="sale_online" />
                                                        <label class="form-check-label">Si</label>
                                                    </div>
                                                    <!--end::Input-->
                                                    <!--begin::Description-->
                                                    <div class="text-muted fs-7">Se permite realizar la reserva en linea del modelo.
                                                    </div>
                                                    <!--end::Description-->
                                                </div>
                                                <!--end::Input group-->
