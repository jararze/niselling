                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                                ...
                                @foreach($values as $vehicle_model)
                                    <tr>
                                        ...
                                        <td data-filter="{{ $vehicle_model->status == 1 ? 'habilitado' : 'no_habilitado' }}">
                                            <div class="badge {{ $vehicle_model->status == 1 ? 'badge-light-success' : 'badge-light-danger' }} fw-bold">
                                                {{ $vehicle_model->status == 1 ? 'Habilitado' : 'No habilitado' }}
                                            </div>
                                        </td>
                                        <td>
                                            <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                <div class="symbol-label">
                                                    <img src="{{ asset($vehicle_model->image) }}" alt="{{ $vehicle_model->slug }}" class="w-100">
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <a href="{{ $vehicle_model->data_sheet }}" target="_blank" class="btn btn-primary" style="font-size: 12px"><i class="bi bi-cloud-arrow-down-fill fs-4 me-2"></i> Descargar</a>
                                        </td>
                                        <td data-filter="{{ $vehicle_model->online_reservation == 1 ? 'SI' : 'NO' }}">
                                                <div class="badge {{ $vehicle_model->online_reservation == 1 ? 'badge-light-success' : 'badge-light-danger' }} fw-bold">
                                                    {{ $vehicle_model->online_reservation == 1 ? 'SI' : 'NO' }}
                                                </div>
                                        </td>
                                        <td>1</td>
                                        <td><div class="badge badge-light-success fw-bold">Habilitado</div></td>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('backend.vehicle.type.edit', $vehicle_model->id) }}"
                                                       class="menu-link px-3">Editar</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="#" data-id="{{ $vehicle_model->id }}" class="menu-link px-3"
