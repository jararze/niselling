...
@push('script')
    <script type="text/javascript">
        window.Laravel = {
            ...
            submitEndpoint: '{{ route("backend.vehicle.type.store") }}',
            deleteEndpoint: '{{ route("backend.vehicle.type.delete", ":id" ) }}'
        };
    </script>
    ...
    <script src="{{ asset('backend/assets/js/types/addType.js') }}"></script>
{{--    <script src="{{ asset('backend/assets/js/types/delete.js') }}"></script>--}}
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                    ...
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#kt_modal_add_customer">Nuevo Tipo
                                    </button>
                                    <!--end::Add customer-->
                                </div>
                                <!--end::Toolbar-->
                        ...
                        <div class="card-body pt-0">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                                ...
                                <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-125px">Tipo Vehículo</th>
                                ...
                                @foreach($values as $typeVehicle)
                                    <tr>
                                        <td>
                                            <div class="form-check form-check-sm form-check-custom form-check-solid">
                                                <input class="form-check-input" type="checkbox" value="{{ $typeVehicle->id }}"/>
                                            </div>
                                        </td>
                                        <td>
                                            <p
                                               class="text-gray-800 text-hover-primary mb-1">{{ $typeVehicle->name }}</p>
                                        </td>
                                        <td data-filter="{{ $typeVehicle->available == 1 ? 'habilitado' : 'no_habilitado' }}">
                                            @if($typeVehicle->available == 1)
                                                <div class="badge badge-light-success fw-bold">Habilitado</div>
                                            @else
                                                <div class="badge badge-light-danger fw-bold">No habilitado</div>
                                            @endif
                                        </td>
                                        <td>{{ $typeVehicle->created_at->format('d M Y, h:i a') }}</td>
                                        <td class="text-end">
                                            <a href="#"
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('backend.vehicle.type.edit', $typeVehicle->id) }}" class="menu-link px-3">Editar</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="#" data-id="{{ $typeVehicle->id }}" class="menu-link px-3"
                            ...
                            <div class="modal-content">
                                ...
                                <form class="form" id="kt_modal_add_customer_form" action="#"
                                    ...
                                    <div class="modal-header" id="kt_modal_add_customer_header">
                                        <!--begin::Modal title-->
                                        <h2 class="fw-bold">Agregar tipo de vehículo</h2>
                                        <!--end::Modal title-->
                                        <!--begin::Close-->
                                        ...
                                        <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll"
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <input type="text" class="form-control form-control-solid" id="name"
                                                       placeholder="Camioneta" name="name" value=""/>
                                                <!--end::Input-->
                                            </div>
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <div class="d-flex flex-stack">
                                                    ...
                                                    <div class="me-5">
                                                        <!--begin::Label-->
                                                        <label class="fs-6 fw-semibold">¿El tipo de vehículo está
                                                            habilitado?</label>
                                                        <!--end::Label-->
                                                        <!--begin::Input-->
