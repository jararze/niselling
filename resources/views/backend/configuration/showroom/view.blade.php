...
@push('script')
    <script type="text/javascript">
        window.Laravel = {
            ...
            submitEndpoint: '{{ route("backend.configuration.showroom.update") }}',
        };
    </script>
    <script src="{{ asset('backend/assets/js/configuration/showroom/edit.js') }}"></script>
@endpush
<x-app-layout>
                ...
                <div id="kt_app_content_container" class="app-container container-fluid">
                    ...
                    <div class="card mb-10">
                        ...
                        <div class="card-body p-5 p-lg-10">
                            <!--begin::Title-->
                            <h1 class="fw-bold text-gray-900 ps-0">Editar Showrooms</h1>
                            <!--end::Title-->
                        </div>
                        <!--end::Card body-->
                    </div>
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-10 fv-row">
                                        <!--begin::Label-->
                                        <label for="type_name" class="required form-label">Nombre showroom</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <select class="form-select mb-2" data-control="select2"
                                            ...
                                            @foreach($cities as $city)
                                                <option value="{{ $city->id }}" {{ ($city->id == $selectedType) ? 'selected' : '' }}>{{ $city->name }}</option>
                                            @endforeach
                                        </select>
                                        <!--begin::Label-->
