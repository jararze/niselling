...
@push('script')
    <script type="text/javascript">
        window.Laravel = {
            ...
            submitEndpoint: '{{ route("backend.configuration.city.update") }}',
        };
    </script>
    <script src="{{ asset('backend/assets/js/configuration/city/edit.js') }}"></script>
@endpush
<x-app-layout>
                ...
                <div id="kt_app_content_container" class="app-container container-fluid">
                    ...
                    <div class="card mb-10">
                        ...
                        <div class="card-body p-5 p-lg-10">
                            <!--begin::Title-->
                            <h1 class="fw-bold text-gray-900 ps-0">Editar Ciudades</h1>
                            <!--end::Title-->
                        </div>
                        <!--end::Card body-->
                    </div>
