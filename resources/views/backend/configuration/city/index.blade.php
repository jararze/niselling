...
@push('script')
    <script type="text/javascript">
        window.Laravel = {
            ...
            submitEndpoint: '{{ route("backend.configuration.city.store") }}',
            deleteEndpoint: '{{ route("backend.configuration.city.delete", ":id" ) }}'
        };
    </script>

    <script src="{{ asset('backend/assets/js/configuration/city/list.js') }}"></script>
    <script src="{{ asset('backend/assets/js/configuration/city/save.js') }}"></script>
@endpush
                ...
                <div id="kt_app_content_container" class="app-container container-fluid">
                    ...
                    <div class="card mb-10">
                        ...
                        <div class="card-body p-5 p-lg-10">
                            <!--begin::Title-->
                            <h1 class="fw-bold text-gray-900 ps-0">Ciudades</h1>
                            <!--end::Title-->
                        </div>
                        <!--end::Card body-->
                    </div>
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                    ...
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#kt_modal_add_customer">Nueva Ciudad
                                    </button>
                                    <!--end::Add customer-->
                                </div>
                                <!--end::Toolbar-->
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                                ...
                                @foreach($values as $city)
                                    <tr>
                                        ...
                                        <td>
                                            <p
                                                class="text-gray-800 text-hover-primary mb-1">{{ $city->name }}</p>
                                        </td>
                                        <td data-filter="{{ $city->status == 1 ? 'habilitado' : 'no_habilitado' }}">
                                            @if($city->status == 1)
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('backend.configuration.city.edit', $city->id) }}" class="menu-link px-3">Editar</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="#" data-id="{{ $city->id }}" class="menu-link px-3"
                        ...
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                            ...
                            <div class="modal-content">
                                ...
                                <form class="form" id="kt_modal_add_customer_form" action="#"
                                      data-kt-redirect="{{ route('backend.configuration.city.index') }}">
                                    @csrf
                                    <!--begin::Modal header-->
                                    <div class="modal-header" id="kt_modal_add_customer_header">
                                        <!--begin::Modal title-->
                                        <h2 class="fw-bold">Agregar Ciudad</h2>
                                        <!--end::Modal title-->
                                        <!--begin::Close-->
                                        ...
                                        <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll"
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <input type="text" class="form-control form-control-solid" id="name"
                                                       placeholder="La Paz" name="name" value=""/>
                                                <!--end::Input-->
                                            </div>
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <div class="d-flex flex-stack">
                                                    ...
                                                    <div class="me-5">
                                                        <!--begin::Label-->
                                                        <label class="fs-6 fw-semibold">¿La ciudad está
                                                            habilitada?</label>
                                                        <!--end::Label-->
                                                        <!--begin::Input-->
