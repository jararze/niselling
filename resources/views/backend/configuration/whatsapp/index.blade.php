...
@push('script')
    <script type="text/javascript">
        window.Laravel = {
            ...
            deleteEndpoint: '{{ route("backend.configuration.whatsapp.delete", ":id" ) }}'
        };
    </script>

    <script src="{{ asset('backend/assets/js/configuration/whatsapp/list.js') }}"></script>
    <script src="{{ asset('backend/assets/js/configuration/whatsapp/save.js') }}"></script>
@endpush
                ...
                <div id="kt_app_content_container" class="app-container container-fluid">
                    ...
                    <div class="card mb-10">
                        ...
                        <div class="card-body p-5 p-lg-10">
                            <!--begin::Title-->
                            <h1 class="fw-bold text-gray-900 ps-0">Contacto whatsapp</h1>
                            <!--end::Title-->
                        </div>
                        <!--end::Card body-->
                    </div>
                        ...
                        <div class="card-body pt-0">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                                ...
                                <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-90px">Telefono</th>
                                    <th class="min-w-90px">Url Visita</th>
                                    <th class="min-w-90px">Id tecnom</th>
                                ...
                                @foreach($messages as $message)
                                    <tr>
                                        ...
                                        <td>
                                            <p class="text-gray-800 text-hover-primary mb-1">{{ $message->name }}</p>
                                        </td>
                                        <td>
                                            <p class="text-gray-800 text-hover-primary mb-1">{{ $message->email }}</p>
                                        </td>
                                        <td>
                                            <p class="text-gray-800 text-hover-primary mb-1">{{ $message->cellphone }}</p>
                                        </td>
                                        <td>
                                            <p class="text-gray-800 text-hover-primary mb-1">{{ $message->pageUrl }}</p>
                                        </td>
                                        <td>{{ $message->tecnom_id }}</td>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('backend.configuration.whatsapp.edit', $message->id) }}" class="menu-link px-3">Ver</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="#" data-id="{{ $message->id }}" class="menu-link px-3"
