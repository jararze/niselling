        ...
        <tr>
            <td style="text-align: left; width: 50%">
                ...
                <div class="text-sm">
                    ...
                    <p style="font-size: 12px">Validez de la oferta: 7 días. Las condiciones podrían variar</p>
                </div>
            </td>
            <td style="text-align: right; width: 50%">
                <div class="justify-between" style="margin-left: 40px">
                    ...
                    <div>
                        <p>Precio Final</p>
                        <p class="font-bold text-nissan" style="color: #c3002f; font-weight: bold">Bs. <span
